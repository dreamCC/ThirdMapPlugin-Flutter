...
public class SwiftThirdMapPlugin: NSObject, FlutterPlugin {

  var result: FlutterResult!
    
  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(name: "third_map_plugin", binaryMessenger: registrar.messenger())
    let instance = SwiftThirdMapPlugin()
...
extension SwiftThirdMapPlugin {
    ...
    private func openBaiduMap(argumentDic: Dictionary<String, String>) {
        ...
        let url = "baidumap://map/direction?destination=\(dlatitude),\(dlongitude)&src=andr.baidu.openAPIdemo"
